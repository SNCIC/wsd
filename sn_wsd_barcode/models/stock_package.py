...
class StockPackage(models.Model):
    ...
    def action_create_from_barcode(self, vals_list):
        ...
        return {
            'stock.package': res.read(self._get_fields_sn_wsd_barcode(), False)
        }
    ...
    def _get_usable_packages(self):
        ...
        records_limit = int(self.env['ir.config_parameter'].sudo().get_param('sn_wsd_barcode.usable_packages_limit'))
