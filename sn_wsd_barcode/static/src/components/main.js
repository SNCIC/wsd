...
import BarcodePickingModel from "@sn_wsd_barcode/models/barcode_picking_model";
import BarcodeQuantModel from "@sn_wsd_barcode/models/barcode_quant_model";
import GroupedLineComponent from "@sn_wsd_barcode/components/grouped_line";
import LineComponent from "@sn_wsd_barcode/components/line";
import PackageLineComponent from "@sn_wsd_barcode/components/package_line";
...
class StockBarcodeUnlinkButton extends Component {
    static template = "sn_wsd_barcode.UnlinkButton";
...
registry.category("view_widgets").add("sn_wsd_barcode_unlink_button", {
    component: StockBarcodeUnlinkButton,
});

/**
 * TODO: sn_wsd_barcode should not depend on base_import.
 */
export class ImportBlockUI extends Component {
    ...
    static template = "sn_wsd_barcode.BlockUI";
}
...
class MainComponent extends Component {
    ...
    static template = "sn_wsd_barcode.MainComponent";
    static components = {
        BarcodeInput,
        BarcodeVideoScanner,
        Chatter,
    ...
    async onWillStart() {
        const barcodeData = await rpc("/sn_wsd_barcode/get_barcode_data", {
            model: this.resModel,
            res_id: this.resId,
        });
        ...
        if (this.config.play_sound) {
            ...
            this.sounds = {
                ...
                success: new Audio(url(`/sn_wsd_barcode/static/src/audio/success.${fileExtension}`)),
            };
    ...
    setupCameraScanner() {
        ...
        this.barcodeVideoScannerProps = {
            ...
            cssClass: "o_sn_wsd_barcode_camera_video",
        };
    }
...
registry.category("actions").add("sn_wsd_barcode_client_action", MainComponent);
