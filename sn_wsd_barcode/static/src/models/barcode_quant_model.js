import { ApplyQuantDialog } from "@sn_wsd_barcode/components/apply_quant_dialog";
import { ConfirmQuantDialog } from "@sn_wsd_barcode/components/confirm_quant_dialog";
import BarcodeModel from "@sn_wsd_barcode/models/barcode_model";
...
export default class BarcodeQuantModel extends BarcodeModel {
    ...
    _getSaveCommand() {
        ...
        if (commands.length) {
            return {
                route: "/sn_wsd_barcode/save_barcode_data",
                params: {
                    model: this.resModel,
                    res_id: false,
                    write_field: false,
    ...
    async _processPackage(barcodeData) {
        ...
        const res = await this.orm.call("stock.quant", "get_sn_wsd_barcode_data_records", [
