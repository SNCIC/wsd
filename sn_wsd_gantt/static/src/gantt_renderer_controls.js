...
export class GanttRendererControls extends Component {
    static template = "sn_wsd_gantt.GanttRendererControls";
    static components = {
        Dropdown,
        DropdownItem,
        GanttScaleSelector,
    ...
    static toolbarContentTemplate = "sn_wsd_gantt.GanttRendererControls.ToolbarContent";
    static rangeMenuTemplate = "sn_wsd_gantt.GanttRendererControls.RangeMenu";
