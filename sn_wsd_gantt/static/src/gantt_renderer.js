...
export class GanttRenderer extends Component {
    ...
    static template = "sn_wsd_gantt.GanttRenderer";
    static connectorCreatorTemplate = "sn_wsd_gantt.GanttRenderer.ConnectorCreator";
    static headerTemplate = "sn_wsd_gantt.GanttRenderer.Header";
    static pillTemplate = "sn_wsd_gantt.GanttRenderer.Pill";
    static groupPillTemplate = "sn_wsd_gantt.GanttRenderer.GroupPill";
    static rowContentTemplate = "sn_wsd_gantt.GanttRenderer.RowContent";
    static rowHeaderTemplate = "sn_wsd_gantt.GanttRenderer.RowHeader";
    static totalRowTemplate = "sn_wsd_gantt.GanttRenderer.TotalRow";
